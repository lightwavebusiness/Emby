...
! function() {
    ...
    window.SC = SC.Helper.merge(SC || {}, {
        ...
        stream: function(idOrUrl, optionsOrCallback, callback) {
            ...
            track_url = 'https://api.soundcloud.com/tracks/155143944?client_id=d47c763873f2jan403dac26b62e3a820&format=json&_status_code_map[302]=200'
    ...
    SC.Loader.registerPackage(new SC.Loader.Package("streaming", function() {
        ...
        if (window.audioManager != null) {
            ...
            return SC.Helper.loadJavascript("js/audiomanager.js", function() {
